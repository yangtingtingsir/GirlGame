...
var slotConfig3x5 = {
    ...
    sprites: [
        // debug reference
        {
            fileName: 'buttonbg.png',
            name: 'buttonbg'
        },
        
        {
            fileName: 'numberbuttonHover.png',
            name: 'numberbuttonHover'
        },
        
        {
            fileName: 'numberbutton.png',
            name: 'numberbutton'
        },
        {
            fileName: 'debug.png',
    ...
    reels:[
        ...
        { // 4
            ...
            windowImage: 'reel',        // not used
            windowsCount: 4,
            addSpinTime: 2500, // additional spin time for reel milliseconds
        }
    ],

     reels_simulate: [0, 0, -1, -1, -1,-1],     // -1 - avoid reel simulate
    ...
    payLines:[
        {
            line: ['Flask', 'Flask', 'Flask', 'Flask', 'Flask', 'Flask'],
            pay: 3,
            freeSpins: 0
        },
        {
            line: ['Flask', 'Flask', 'Flask', 'Flask', 'any', 'any'],
            pay: 2,
            freeSpins: 0
        },
        {
            line: ['Flask', 'Flask', 'Flask', 'any', 'any', 'any'],
            pay: 1,
            freeSpins: 0
        },
        {
            line: ['Hat', 'Hat', 'Hat', 'Hat', 'Hat', 'Hat'],
            pay: 5,
            freeSpins: 0
        },
        {
            line: ['Hat', 'Hat', 'Hat', 'Hat', 'any', 'any'],
            pay: 3,
            freeSpins: 0
        },
        {
            line: ['Hat', 'Hat', 'Hat', 'any', 'any', 'any'],
            pay: 1,
            freeSpins: 0
        },
        {
            line: ['Gun', 'Gun', 'Gun', 'Gun', 'Gun', 'Gun'],
            pay: 7,
            freeSpins: 0
        },
        {
            line: ['Gun', 'Gun', 'Gun', 'Gun', 'any', 'any'],
            pay: 3,
            freeSpins: 0
        },
        {
            line: ['Gun', 'Gun', 'Gun', 'any', 'any', 'any'],
            pay: 2,
            freeSpins: 0
        },
        {
            line: ['Bag', 'Bag', 'Bag', 'Bag', 'Bag', 'Bag'],
            pay: 8,
            freeSpins: 0
        },
        {
            line: ['Bag', 'Bag', 'Bag', 'Bag', 'any', 'any'],
            pay: 3,
            freeSpins: 0
        },
        {
            line: ['Bag', 'Bag', 'Bag', 'any', 'any', 'any'],
            pay: 2,
            freeSpins: 0
        },
        {
            line: ['Crosses', 'Crosses', 'Crosses', 'Crosses', 'Crosses', 'Crosses'],
            pay: 17,
            freeSpins: 0
        },
        {
            line: ['Crosses', 'Crosses', 'Crosses', 'Crosses', 'any', 'any'],
            pay: 13,
            freeSpins: 0
        },
        {
            line: ['Crosses', 'Crosses', 'Crosses', 'any', 'any', 'any'],
            pay: 11,
            freeSpins: 0
        },
        {
            line: ['Diamonds', 'Diamonds', 'Diamonds', 'Diamonds', 'Diamonds', 'Diamonds'],
            pay: 19,
            freeSpins: 0
        },
        {
            line: ['Diamonds', 'Diamonds', 'Diamonds', 'Diamonds', 'any', 'any'],
            pay: 13,
            freeSpins: 0
        },
        {
            line: ['Diamonds', 'Diamonds', 'Diamonds', 'any', 'any', 'any'],
            pay: 11,
            freeSpins: 0
        },
        {
            line: ['Hearts', 'Hearts', 'Hearts', 'Hearts', 'Hearts', 'Hearts'],
            pay: 20,
            freeSpins: 0
        },
        {
            line: ['Hearts', 'Hearts', 'Hearts', 'Hearts', 'any', 'any'],
            pay: 14,
            freeSpins: 0
        },
        {
            line: ['Hearts', 'Hearts', 'Hearts', 'any', 'any', 'any'],
            pay: 11,
            freeSpins: 0
        },
        {
            line: ['Spades', 'Spades', 'Spades', 'Spades', 'Spades', 'Spades'],
            pay: 25,
            freeSpins: 0
        },
        {
            line: ['Spades', 'Spades', 'Spades', 'Spades', 'any', 'any'],
            pay: 15,
            freeSpins: 0
        },
        {
            line: ['Spades', 'Spades', 'Spades', 'any', 'any', 'any'],
            pay: 11,
            freeSpins: 0
        },
    ],
...
*/
       ...
       // scene.lanternright =  scene.addSpriteLocPos('lantern_right', 720, -463).setOrigin(0.5, 0.05);   
        ...
        scene.columnLeft =  scene.addSpriteLocPos('column_left', -670, -40);
        scene.columnRight =  scene.addSpriteLocPos('column_right', 830, -400);
        scene.buttonbg =  scene.addSpriteLocPos('buttonbg', 0, 400);
    ...
    createReels: function(scene) {
        ...
        {
            _reels.push(new Reel(scene, this.reels[ri], ri, this.symbolSizeY - 35, this.reels[ri].windowsCount, true, this.spinTime, this.symbAnimFrameRate));
        }
        return _reels;
    },
...
//        slotControls.linesPanel.setDepth(depth); 
        slotControls.totalbetPanel = scene.addSpriteLocPos('panel_totalbet', 270, 400);
        slotControls.totalbetPanel.setDepth(depth);
        slotControls.balancePanel = scene.addSpriteLocPos('panel_balance', -350, 400);
        slotControls.balancePanel.setDepth(depth);
        slotControls.winPanel = scene.addSpriteLocPos('panel_totalbet', 450, 400);
        ...
        slotControls.totalBetMinusButton.create(-180, 397, 0.5, 0.5);
        slotControls.totalBetMinusButton.addClickEvent(slotControls.lineBetMinus_Click, slotControls);
        slotControls.totalBetMinusButton.addClickEvent(()=>{
            var betNum = slotControls.getTotalBet();
            var btnNum = parseInt(slotControls.number1.text);
            if(betNum < btnNum && betNum > 20){
                slotControls.number1.text = parseInt(slotControls.number1.text) - 100;
                slotControls.number2.text = parseInt(slotControls.number2.text) - 100;
                slotControls.number3.text = parseInt(slotControls.number3.text) - 100;
                slotControls.number4.text = parseInt(slotControls.number4.text) - 100;
                slotControls.number5.text = parseInt(slotControls.number5.text) - 100;
...
//        // totalbet plus button
        ...
        slotControls.totalBetPlusButton.create(183 , 397, 0.5, 0.5);
        slotControls.totalBetPlusButton.addClickEvent(slotControls.lineBetPlus_Click, slotControls);
        slotControls.totalBetPlusButton.addClickEvent(()=>{
            var betNum = slotControls.getTotalBet();
            var btnNum = parseInt(slotControls.number5.text);
            if(betNum > btnNum && betNum < 400){
                slotControls.number1.text = parseInt(slotControls.number1.text) + 100;
                slotControls.number2.text = parseInt(slotControls.number2.text) + 100;
                slotControls.number3.text = parseInt(slotControls.number3.text) + 100;
                slotControls.number4.text = parseInt(slotControls.number4.text) + 100;
        ...
        slotControls.totalnumberButton1 = new SceneButton(scene, 'numberbutton','numberbuttonHover', false);
        slotControls.buttons.push(slotControls.totalnumberButton1);
        slotControls.totalnumberButton1.create(-128 , 397, 0.5, 0.5);
        slotControls.totalnumberButton1.addClickEvent(()=>{
            var betNum = slotControls.getTotalBet();
            var btnNum = parseInt(slotControls.number1.text);
            if(betNum < btnNum){
                slotControls.tmpNumberNum = (btnNum - betNum)/20;
            }else if(betNum > btnNum){
                slotControls.tmpNumberNum = 0 - (betNum - btnNum)/20;

            }
        }, this);
      
        slotControls.totalnumberButton1.addClickEvent(slotControls.lineBetNumber_Click, slotControls);
        slotControls.totalnumberButton1.setDepth(depth);
        
        slotControls.totalnumberButton2 = new SceneButton(scene, 'numberbutton','numberbuttonHover', false);
        slotControls.buttons.push(slotControls.totalnumberButton2);
        slotControls.totalnumberButton2.create(-63 , 397, 0.5, 0.5)
        slotControls.totalnumberButton2.addClickEvent(()=>{
            var betNum = slotControls.getTotalBet();
            var btnNum = parseInt(slotControls.number2.text);
            if(betNum < btnNum){
                slotControls.tmpNumberNum = (btnNum - betNum)/20;
            }else if(betNum > btnNum){
                slotControls.tmpNumberNum = 0 - (betNum - btnNum)/20;
        ...
        slotControls.totalnumberButton2.addClickEvent(slotControls.lineBetNumber_Click, slotControls);
        slotControls.totalnumberButton2.setDepth(depth);
        
        slotControls.totalnumberButton3 = new SceneButton(scene, 'numberbutton','numberbuttonHover', false);
        slotControls.buttons.push(slotControls.totalnumberButton3);
        slotControls.totalnumberButton3.create(2 , 397, 0.5, 0.5);
        slotControls.totalnumberButton3.addClickEvent(()=>{
            var betNum = slotControls.getTotalBet();
            var btnNum = parseInt(slotControls.number3.text);
            if(betNum < btnNum){
                slotControls.tmpNumberNum = (btnNum - betNum)/20;
            }else if(betNum > btnNum){
                slotControls.tmpNumberNum = 0 - (betNum - btnNum)/20;
        ...
        slotControls.totalnumberButton3.addClickEvent(slotControls.lineBetNumber_Click, slotControls);
        slotControls.totalnumberButton3.setDepth(depth);
        
        slotControls.totalnumberButton4 = new SceneButton(scene, 'numberbutton','numberbuttonHover', false);
        slotControls.buttons.push(slotControls.totalnumberButton4);
        slotControls.totalnumberButton4.create(68 , 397, 0.5, 0.5);
        slotControls.totalnumberButton4.addClickEvent(()=>{
            var betNum = slotControls.getTotalBet();
            var btnNum = parseInt(slotControls.number4.text);
            if(betNum < btnNum){
                slotControls.tmpNumberNum = (btnNum - betNum)/20;
            }else if(betNum > btnNum){
                slotControls.tmpNumberNum = 0 - (betNum - btnNum)/20;
        ...
        slotControls.totalnumberButton4.addClickEvent(slotControls.lineBetNumber_Click, slotControls);
        slotControls.totalnumberButton4.setDepth(depth);
        
        
        slotControls.totalnumberButton5 = new SceneButton(scene, 'numberbutton','numberbuttonHover', false);
        slotControls.buttons.push(slotControls.totalnumberButton5);
        slotControls.totalnumberButton5.create(132 , 397, 0.5, 0.5);
        slotControls.totalnumberButton5.addClickEvent(()=>{
            var betNum = slotControls.getTotalBet();
            var btnNum = parseInt(slotControls.number5.text);
            if(betNum < btnNum){
                slotControls.tmpNumberNum = (btnNum - betNum)/20;
        ...
        slotControls.totalnumberButton5.addClickEvent(slotControls.lineBetNumber_Click, slotControls);
        slotControls.totalnumberButton5.setDepth(depth);
...
//        slotControls.slotMaxBetButton.setDepth(depth);
        ...
        slotControls.slotAutoSpinButton.create(750, 400, 0.5, 0.5);
        ...
        slotControls.slotSpinButton.create(630, 380, 0.5, 0.5);
        ...
        slotControls.menuButton.create(-630, 400, 0.5, 0.5);
        ...
        slotControls.creditSumText = scene.add.bitmapText(scene.centerX - 350, scene.centerY + 400, 'gameFont_1', '' + scene.slotPlayer.coins, 42, 1).setOrigin(0.5);
        ...
        slotControls.settingsButton.create(-630, 300, 0.5, 0.5);
       ...
       slotControls.rulesButton.create(-630, 200, 0.5, 0.5);
...
//        slotControls.linesCountText.depth = depth;
        slotControls.number1 = scene.add.bitmapText(scene.centerX -128, scene.centerY + 397, 'gameFont_1', '20', 30, 1).setOrigin(0.5);
        slotControls.number1.depth = depth;
        
        slotControls.number2 = scene.add.bitmapText(scene.centerX -63 , scene.centerY + 397, 'gameFont_1', '40', 30, 1).setOrigin(0.5);
        slotControls.number2.depth = depth;
        
        slotControls.number3 = scene.add.bitmapText(scene.centerX + 2, scene.centerY + 397, 'gameFont_1', '60', 30, 1).setOrigin(0.5);
        slotControls.number3.depth = depth;
        
        slotControls.number4 = scene.add.bitmapText(scene.centerX + 68, scene.centerY + 397, 'gameFont_1', '80', 30, 1).setOrigin(0.5);
        slotControls.number4.depth = depth;
        
        slotControls.number5 = scene.add.bitmapText(scene.centerX + 132, scene.centerY + 397, 'gameFont_1', '100', 30, 1).setOrigin(0.5);
        slotControls.number5.depth = depth;
        ...
        slotControls.totalBetText = scene.add.bitmapText(scene.centerX + 270, scene.centerY + 370, 'gameFont_2', 'TOTAL  BET', 20, 1).setOrigin(0.5);
        slotControls.totalBetText.depth = depth;
  
        slotControls.totalBetSumText = scene.add.bitmapText(scene.centerX + 275, scene.centerY + 400, 'gameFont_1', slotControls.getTotalBet(), 42, 1).setOrigin(0.5);
        slotControls.totalBetSumText.depth = depth;
 
        slotControls.creditText = scene.add.bitmapText(scene.centerX - 350, scene.centerY + 370, 'gameFont_2', 'BALANCE', 20, 1).setOrigin(0.5);
        slotControls.creditText.depth = depth;

         
        slotControls.winText = scene.add.bitmapText(scene.centerX + 450, scene.centerY + 370, 'gameFont_2', 'YOUR  WIN', 20, 1).setOrigin(0.5);
        slotControls.winText.depth = depth;

        slotControls.winAmountText = scene.add.bitmapText(scene.centerX + 450, scene.centerY + 400, 'gameFont_1', '0', 42, 1).setOrigin(0.5);
...
//        slotControls.maxBetText1.depth = depth;
        ...
        slotControls.spinText = scene.add.bitmapText(scene.centerX + 628, scene.centerY + 185 + 200, 'gameFont_2', ' ', 30, 1).setOrigin(0.5);
    ...
    createSettingsPUHandler: function(popup,slotControls)
    {
        ...
        popup.privacyText = popup.scene.add.bitmapText(-2, 0 + yOffset, 'gameFont_1', 'RESET BALANCE', 30, 1).setOrigin(0.5);
        popup.add(popup.privacyText);

        popup.termsText = popup.scene.add.bitmapText(-2, 110 + yOffset, 'gameFont_1', 'ADD 10000 BALANCE', 25, 1).setOrigin(0.5);
